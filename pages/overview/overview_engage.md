...
- Look through the design decisions made so far in relation to each capability pack ([Foundations](foundations_design.html), [Appointment Management](appointments_design.html) and [Access Record Structured](accessrecord_rest.html)) and get involved:
